...
function TraumatologicView({
	...
	const handleSaveNewTrauma = async () => {
		if (
			...
			setError(
				"Por favor, complete todos los campos antes de guardar el registro traumatológico",
			);
		...
		>
			...
			{addingNew || selectedTrauma ? (
				...
				>
					<h2>
						{selectedTrauma
							? "Editar Antecedente Traumatológico"
							: "Nuevo Antecedente Traumatológico"}
					</h2>
					...
					<div>
						...
						<DropdownMenu
							...
							onChange={(selectedOption) =>
								handleFieldChange("year", selectedOption.value)
							}
