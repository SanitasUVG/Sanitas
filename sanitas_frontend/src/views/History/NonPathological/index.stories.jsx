...
export default {
  ...
  title: "Views/NonPathologicalHistory",
};

const dummyPatientId = 12345;

const mockGetBloodTypePatientInfo = async (id) => ({
  result: {
    bloodType: "O+",
  },
});

const mockGetNonPathologicalHistoryWithData = async (id) => ({
  result: {
    medicalHistory: {
      smoker: { data: [{ smokes: true, cigarettesPerDay: 10, years: 5 }], version: 1 },
      drink: { data: [{ drinks: true, drinksPerMonth: 5 }], version: 1 },
      drugs: { data: [{ usesDrugs: true, drugType: "Cannabis", frequency: "Weekly" }], version: 1 },
    },
    bloodType: "O+",
  },
});

const mockGetNonPathologicalHistoryEmpty = async (id) => ({
  result: {
    medicalHistory: {
...
const mockGetNonPathologicalHistoryError = async (id) => ({
  error: {
    response: {
      status: 400,
...
const mockUpdateNonPathologicalHistory = async (id, history, version) => ({
