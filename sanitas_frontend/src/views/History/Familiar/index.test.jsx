...
const mockUpdateFamiliarHistory = vi.fn(() => Promise.resolve({ success: true }));
...
describe("FamiliarHistory Component Tests", () => {
  ...
  test("adds a new familiar history record", async () => {
    ...
    await waitFor(() => expect(toast.success).toHaveBeenCalledWith("Historial familiar guardado con éxito."));
  });
});
