...
export function StudentSurgicalHistory({
  ...
  const studentSurgicalHistoryResource = WrapPromise(getStudentSurgicalHistory(id));
 ...
 */
function StudentSurgicalView({ id, birthdayResource, studentSurgicalHistoryResource, updateStudentSurgicalHistory }) {
  ...
  let sortedData = studentSurgicalHistoryData?.medicalHistory.surgeries.data || [];
  ...
  const handleSaveNewSurgery = async () => {
    ...
    updatedStudentSurgicalHistory.data.sort((a, b) => b.surgeryYear - a.surgeryYear);
