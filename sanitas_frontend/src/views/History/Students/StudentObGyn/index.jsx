  ...
  return (
    ...
    >
      <div>
        ...
        >
          <StudentDashboardTopbar {...sidebarConfig} activeSectionProp="ginecoobstetricos" />
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            Por favor, completa la información solicitada; será tratada con estricta
            confidencialidad.
          </h3>
        </div>
...
function OperationSection({
  ...
  const [operationDetails, setOperationDetails] = useState(() => {
    const initialDetails = isArray ? operationDetailsResource : [operationDetailsResource];
...
function ObGynView({
  ...
  const isFirstTime = !(
    gynecologicalHistoryResult.result?.medicalHistory?.diagnosedIllnesses?.data.length ||
  ...
  const hasBeenEdited =
    operations.some((op) => op.hasBeenEdited) || diagnoses.some((d) => d.hasBeenEdited);
              ...
              >
                ...
                {operations.map((operation, index) => {
                  ...
                  const requestDetails =
                    getRequestOperations.find((op) => op.key === operation.key)?.details || {};
