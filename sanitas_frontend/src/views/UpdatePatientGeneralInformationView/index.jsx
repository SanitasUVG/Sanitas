...
export default function UpdatePatientInfoView({
  ...
  return (
    ...
    >
      ...
      >
        <StudentDashboardTopbar {...sidebarConfig} activeSectionProp="general" />
      </div>
      ...
      >
        <Suspense fallback={<Throbber loadingMessage="Cargando datos de paciente..." />}>
          <h1
            style={{
          ...
          >
            Por favor, ayúdanos completando la siguiente información para poder conocerte mejor y
 ...
 */
function UpdateColaboratorInformationSection({ getData, updateData, triggerRefresh, isMobile }) {
  const styles = {
    form: {
      padding: "3rem 2rem",
        ...
        <div style={{ ...columnStyles, paddingLeft: "0", paddingRight: "0" }}>
          ...
          <div style={inputContainerStyles}>
            ...
            <DateInput
              ...
              readOnly={() => hasPropertyAndIsValid(responseFromGET, "birthdate")}
          ...
          <Collapsable title="Contacto 1" isCollapsed={false}>
            <div style={collapsableInnerStyle}>
              ...
              <BaseInput
                ...
                style={inputStyles}
                disabled={hasPropertyAndIsValid(responseFromGET, "contactName1")}
              ...
              <BaseInput
                ...
                style={inputStyles}
                disabled={hasPropertyAndIsValid(responseFromGET, "contactKinship1")}
              ...
              <BaseInput
                ...
                style={inputStyles}
                disabled={hasPropertyAndIsValid(responseFromGET, "contactPhone1")}
          ...
          <Collapsable title="Contacto 2" isCollapsed={false}>
            <div style={collapsableInnerStyle}>
              ...
              <BaseInput
                ...
                style={inputStyles}
                disabled={hasPropertyAndIsValid(responseFromGET, "contactName2")}
                placeholder="Nombre de contacto"
              />
              ...
              <BaseInput
                ...
                style={inputStyles}
                disabled={hasPropertyAndIsValid(responseFromGET, "contactKinship2")}
                placeholder="Parentesco de contacto"
              />
              ...
              <BaseInput
                ...
                style={inputStyles}
                disabled={hasPropertyAndIsValid(responseFromGET, "contactPhone2")}
                placeholder="Teléfono de contacto"
              />
            </div>
          </Collapsable>
 ...
 */
function UpdateStudentInformationSection({ getData, updateData, triggerRefresh, isMobile }) {
  const styles = {
    form: {
      padding: "3rem 2rem",
      borderRadius: "5px",
      ...
      >
        ...
        >
          ...
          <BaseInput
            ...
            onChange={(e) => setPatientData({ ...patientData, carnet: e.target.value })}
            placeholder="Carnet"
            style={inputStyles}
        ...
        >
          ...
          <BaseInput
            ...
            onChange={(e) => setPatientData({ ...patientData, career: e.target.value })}
            placeholder="Carrera"
            style={inputStyles}
            maxLength={100}
          />
